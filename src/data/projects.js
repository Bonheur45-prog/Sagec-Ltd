...
export const projects = [
  ...
  },
  {
    ...
    featured: false,
    shortDescription:
      'A premium residential development delivering modern living spaces designed for comfort, elegance, and lasting quality. SAGEC completes G & D House — a contemporary residential project that reflects the firm\'s dedication to quality, functionality, and aesthetic excellence.',
    description:
  ...
  },
  {
    ...
    featured: false,
    shortDescription:
      'A major infrastructure project delivering lasting public value through precision engineering and expert construction management. SAGEC completes Hall Mark Center — a state-of-the-art commercial facility that showcases the firm\'s commitment to innovation and excellence in design.',
    description:
      'Placeholder — replace with real project details when ready.',
